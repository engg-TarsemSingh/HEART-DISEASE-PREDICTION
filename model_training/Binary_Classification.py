...
training_dataSet = df[:150].copy()
testing_dataSet = df[150:].copy()
training_dataSet.to_csv(r"training_dataSet.csv",index=False)
...
for i in range(df.shape[1]-1):
    ...
    training_dataSet[col[i]] = training_dataSet[col[i]]/maxi


'''                           dividing training set into feature and output                                         '''
